...
I2C_HandleTypeDef* ssd1306_hi2c;
...
{
	memcpy(SSD1306_Buffer, data, SSD1306_WIDTH * SSD1306_HEIGHT / 8);
}
...
void ssd1306_ClearLine(uint8_t y, FontDef Font, SSD1306_COLOR color)
{
	...
	{
		for (uint32_t j = 0; j < Font.FontHeight; j++)
		{
			ssd1306_DrawPixel(i, y+j, color);
		}
	}
